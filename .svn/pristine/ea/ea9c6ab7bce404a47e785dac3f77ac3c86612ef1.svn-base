...
import { columnDefsBillingDescriptionReports } from './renewal-output.data';
...
@Component({
  selector: 'app-renewal-output',
  templateUrl: './renewal-output.component.html',
  styleUrls: ['./renewal-output.component.css']
})
export class RenewalOutputComponent extends BaseComponent implements OnInit {
