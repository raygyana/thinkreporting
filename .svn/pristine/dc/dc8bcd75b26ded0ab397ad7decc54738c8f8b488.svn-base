...
import { columnDefsBillingDescriptionReports } from './nth.data';
...
@Component({
  selector: 'app-nth',
  templateUrl: './nth.component.html',
  styleUrls: ['./nth.component.css']
})
export class NthComponent extends BaseComponent implements OnInit {
