    ...
    MyDatePicker.prototype.writeValue = function (value) {
        if (value) {
            if (value.day && value.month && value.year) {
                this.selectedDate = this.parseSelectedDate(value);
            }
            else if (typeof value.getMonth === 'function') {
                this.selectedDate = this.parseSelectedDate(this.jsDateToMyDate(value));
            }
            else {
                var date = new Date(value);
                if (date.toString() != 'Invalid Date') {
                    this.selectedDate = this.parseSelectedDate(this.jsDateToMyDate(date));
                }
                else {
                    this.selectedDate = {
                        year: 0,
