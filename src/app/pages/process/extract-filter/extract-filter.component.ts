...
import { columnDefsBillingDescriptionReports } from './extract-filter.data';
...
@Component({
  ...
  templateUrl: './extract-filter.component.html',
  styleUrls: ['./extract-filter.component.css']
})
export class ExtractFilterComponent extends BaseComponent implements OnInit {
