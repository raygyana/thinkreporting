...
import { columnDefsRenewalDescReports } from './renewal-tab.data';
import { columnDefsRenewalDefinitionReports } from './renewal-tab.data';
import { columnDefsRenewalOrderClassReports } from './renewal-tab.data';
import { columnDefsRenewalEffortsReports } from './renewal-tab.data';
...
@Component({
  selector: 'app-renewal-tab',
  templateUrl: './renewal-tab.component.html',
  styleUrls: ['./renewal-tab.component.css']
})
export class RenewalTabComponent extends BaseComponent implements OnInit {
  ...
  getServiceUrl(name): any {
    if (name === this.RENEWAL_DESCRIPTION_REPORTS) {
      ...
      return ProcessUrls.TK_RENEWAL_EFFORT_URL;
    }
  }
