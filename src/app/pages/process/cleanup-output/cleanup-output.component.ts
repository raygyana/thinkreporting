...
// @Component({
//   selector: 'app-cleanup-output',
//   templateUrl: './cleanup-output.component.html',
//   styleUrls: ['./cleanup-output.component.css']
// })
// export class CleanupOutputComponent implements OnInit {
...
//   }
//   openAddNew() {
//     this.router.navigate(['pages/cleanup_add']);
...
import { columnDefsBillingDescriptionReports } from './cleanup-output.data';
...
export class CleanupOutputComponent extends BaseComponent implements OnInit {
