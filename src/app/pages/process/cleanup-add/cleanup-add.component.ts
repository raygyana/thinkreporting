...
import { columnDefsBillingDescriptionReports } from './cleanup-add.data';
...
@Component({
  selector: 'app-cleanup-add',
  templateUrl: './cleanup-add.component.html',
  styleUrls: ['./cleanup-add.component.css']
})
export class CleanupAddComponent extends BaseComponent implements OnInit {
