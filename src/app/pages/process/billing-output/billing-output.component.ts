...
import { columnDefsBillingDescriptionReports } from './billing-output.data';
...
@Component({
  selector: 'app-billing-output',
  templateUrl: './billing-output.component.html',
  styleUrls: ['./billing-output.component.css']
})
export class BillingOutputComponent extends BaseComponent implements OnInit {
