...
import { EditOrderModel } from '../edit-order/edit-order.model';
...
export class PackageEditComponent extends BaseComponent {
  ...
  renewoptionSetting: any;
  billingoptionSetting: any;
  ...
  renewalOptionClick() {
    this.customModalPopService.show(this.renewoptionSetting);
  }
  billingOptionClick() {
    this.customModalPopService.show(this.billingoptionSetting);
  }
  ...
  createReseDataPopoup() {
    ...
    this.renewoptionSetting = new CustomModalPopUpModel('Renewal Option', true, true, false);
    this.billingoptionSetting = new CustomModalPopUpModel('Billing Option', true, true, false);
